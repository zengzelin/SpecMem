...
def build_audit_record(sample_id, base_record, candidate_record):
    ...
    return {
        ...
        "candidate_trigger_metric": candidate_record.get("trigger_metric", "confidence_score"),
        "candidate_accept_metric": candidate_record.get("accept_metric", "confidence_score"),
        ...
        "candidate_tail_score_raw": candidate_record.get("tail_score_raw"),
        "candidate_tail_score_memory": candidate_record.get("tail_score_memory"),
        "candidate_bottom10_group_score_raw": candidate_record.get("bottom10_group_score_raw"),
        "candidate_bottom10_group_score_memory": candidate_record.get("bottom10_group_score_memory"),
        "candidate_tail_gain": candidate_record.get("tail_gain"),
        "candidate_bottom10_gain": candidate_record.get("bottom10_gain"),
